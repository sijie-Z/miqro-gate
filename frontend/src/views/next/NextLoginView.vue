...
<template>
  <main class="gate-auth" data-testid="login-panel" data-i18n-ignore>
    <!-- Dark hero: gateway portal scene (code-drawn, no bitmap) -->
      ...
      <div class="hero-content">
        ...
        <div class="gate-scene" aria-hidden="true">
          ...
          <svg class="scene-lines" viewBox="0 0 760 540" preserveAspectRatio="none">
            ...
            <ellipse cx="372" cy="258" rx="180" ry="132" fill="none" stroke="#7c87ff" stroke-opacity=".24" stroke-dasharray="3 8" />
            <ellipse cx="372" cy="258" rx="250" ry="183" fill="none" stroke="#6772e9" stroke-opacity=".12" stroke-dasharray="2 12" />
            ...
            <path d="M145 176 C250 176 295 212 346 238 M138 270 C257 270 289 262 343 252 M163 357 C261 348 294 294 344 269" stroke="#8790ff" stroke-opacity=".32" stroke-width="9" filter="url(#blur)" fill="none" />
          </svg>

          <div class="provider-card provider-openai">
            <span class="provider-logo openai">✳</span>
            <span>OpenAI</span>
            <i />
          </div>
          <div class="provider-card provider-anthropic">
            <span class="provider-logo anthropic">AI</span>
            <span>Anthropic</span>
            <i />
          </div>
          <div class="provider-card provider-deepseek">
            <span class="provider-logo deepseek">◈</span>
            <span>DeepSeek</span>
            <i />
          </div>
          <div class="provider-card provider-custom">
            <span class="provider-logo custom">⌁</span>
...
.gate-auth {
  ...
  min-height: 100vh;
  display: grid;
  /* 1.06 / 0.94 — the reference implementation's hero:panel split. */
...
.provider-card {
  ...
  box-shadow: 0 16px 30px rgba(0, 0, 0, 0.26), inset 0 1px 0 rgba(255, 255, 255, 0.07);
...
.gate-column-left {
  ...
  box-shadow: -22px 0 50px rgba(71, 90, 255, 0.1), inset 10px 0 23px rgba(101, 112, 255, 0.12);
}
.gate-column-right {
  right: 0;
  border-left: 0;
  ...
  transform: perspective(200px) rotateY(-7deg);
  box-shadow: 22px 0 50px rgba(75, 89, 255, 0.13), inset -10px 0 25px rgba(101, 112, 255, 0.16);
}
.gate-top {
  position: absolute;
  left: 4%;
  ...
  box-shadow: 0 0 38px rgba(99, 111, 255, 0.11), inset 0 1px 0 rgba(255, 255, 255, 0.08);
}
.gate-inner-glow {
  position: absolute;
  left: 16%;
