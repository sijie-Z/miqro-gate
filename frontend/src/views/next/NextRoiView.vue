...
import { CHART_OTHER_COLOR, CHART_PALETTE, CHART_SUCCESS_COLOR } from '@/lib/chart-palette';
...
const composition = computed(() => {
  ...
  // #1126: this list is sorted by value below, so any two colours can end up side by
  // side — the set has to separate at *every* pair, not just the ones written in order.
  // The amber is the theme's orange preset; the other three come from the shared
  // palette so the green cannot drift back to the ad-hoc hex that failed at ΔE 0.4.
  return [
