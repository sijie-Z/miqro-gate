...
export interface paths {
    ...
    "/api/v1/admin/mcp-services/{serviceId}/tools/sync": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/admin/mcp-services/{serviceId}/tools/import": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        post: operations["importFromOpenApi"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/admin-api/webhooks/{endpointId}/test": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/admin/reconciliations/{reportId}/rows": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/admin/mcp-services/{serviceId}/traffic": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/admin-api/webhooks/{endpointId}/deliveries": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/admin-api/usage/summary": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/admin-api/usage/records": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/admin-api/mcp-access-logs": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/admin-api/export-tasks/{taskId}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
...
export interface components {
    schemas: {
        ...
        UsageAdjustmentRequest: {
            ...
            /** Format: int64 */
            cacheCreationTokensDelta?: number;
            reason?: string;
            reasonCode?: string;
            /** Format: uuid */
            reversalOfId?: string;
        ...
        JsonNode: unknown;
        ImportResult: {
            created?: components["schemas"]["McpTool"][];
            skipped?: components["schemas"]["ImportSkip"][];
            parseSkips?: components["schemas"]["SkipNote"][];
        };
        ImportSkip: {
            toolName?: string;
            reason?: string;
        ...
        ProviderProduct: {
            ...
            planScope?: "NONE" | "PERSONAL" | "TEAM" | "ENTERPRISE";
            /** @enum {string} */
            credentialTopology?: "SINGLE_SHARED" | "MULTI_KEY_SHARED_POOL" | "PER_SEAT_KEY" | "PER_MEMBER_SUBSCRIPTION_KEY";
            /** @enum {string} */
            quotaTopology?: "NONE" | "GLOBAL_SHARED" | "MEMBER_ISOLATED" | "DEDICATED_PLUS_SHARED" | "KEY_CAPPED";
            ...
            /** @enum {string} */
            implementationStatus?: "DRAFT" | "DOCUMENTED" | "IMPLEMENTED" | "VERIFIED" | "DEGRADED" | "DISABLED";
...
export interface operations {
    ...
    get_1: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["RetentionConfig"];
                };
            };
        };
    };
    ...
    list_5: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["UsageAdjustmentView"][];
                };
            };
        };
    };
    append: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["UsageAdjustmentRequest"];
            };
        };
        responses: {
            /** @description OK */
    ...
    revisions: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["McpToolRevision"][];
                };
            };
        };
    };
    ...
    registrationStatus: {
        ...
        requestBody?: never;
        responses: {
            /** @description Self-registration switch state (single boolean, anonymous) */
            200: {
                headers: {
                    [name: string]: unknown;
                };
