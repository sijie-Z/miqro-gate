# MiQroKey Control Plane image (#479). Build context is the repository root:
...
RUN --mount=type=cache,target=/root/.m2 \
    mvn -B -ntp -f backend/pom.xml -pl control-plane-app -am package -DskipTests
...
WORKDIR /app
COPY --from=build --chown=10001:10001 /src/backend/control-plane-app/target/control-plane-app-*-exec.jar /app/app.jar
USER 10001:10001
EXPOSE 8080
