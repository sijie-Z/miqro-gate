...
> **2026-09-07 审计注**：文内路由/端点表为早期形态（如 `/api/auth/login`、TDesign 页）；现行契约以
> `api-contract.md` 与前端路由/`frontend-design.md` 为准。门户语言「中文优先，保留供应商/模型/Token/
> Virtual Key 等通用英文术语」条款继续有效（owner 2026-09-07 确认中文产品）。本文保留作历史对照。
