...
- 分支 `fix/ph87-multi-instance-consistency`；issue #1383 / #1394；#1383 的修复 PR **#1404**（https://github.com/sijie-Z/miqro-gate/pull/1404，base `develop`）**已合并**（merge commit `cafc5e1e`，2026-09-22T10:41:09Z；评审后追加的并发用例「保鲜闸门」修正是该 PR 的第 4 个提交 `0cd5fa63`）；本交接点的文字订正另开一个小文档 PR（不在 #1404 内）。
