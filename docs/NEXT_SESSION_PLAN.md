...
- [~] U2 管理面三组逐批切换 —— **组织组首批完成**（PR #134 @ goal/ui-u2-org-console：用户/团队/项目/授权/审批中心 5 页 v2 + UiDrawer 原语；vitest 139/139、Playwright 40/40；视觉评审运行中）；**待做第二批平台组**（供应商/订阅/定价/上游凭证/用量报表/成本报表/配额规则/缓存收益）→ 第三批运营组
- [ ] U2 管理面三组逐批切换
