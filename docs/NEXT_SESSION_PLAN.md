...
- [~] U2 管理面三组逐批切换 —— **组织组首批完成**（PR #134 @ goal/ui-u2-org-console 087c1df：5 页 v2 + UiDrawer；vitest 139/139、Playwright 40/40；两轮视觉评审中位 users 8.5/teams 6.5/projects 7.5/grants 6.8/approval 6.8，噪声较大以中位记档 miqro-local/ui-reviews/u2-*）；**待做第二批平台组**（供应商/订阅/定价/上游凭证/用量报表/成本报表/配额规则/缓存收益）→ 第三批运营组
- [ ] U2 管理面三组逐批切换
