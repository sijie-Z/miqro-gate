 ...
 * label's preview. {@code boundProjects} lists every project the key may serve
 * (ADR-0018); {@code projectId}/{@code projectTag} keep the primary project for
...
public record VirtualKeyView(UUID id, String name, VirtualKeyPurpose purpose, VirtualKeyStatus status,
        ...
        List<BoundProjectView> boundProjects, String cachePolicy, String baseUrl, Instant createdAt, Instant lastUsedAt,
        Instant revokedAt) {
}
