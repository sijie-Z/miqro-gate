-- V24: QUOTA_THRESHOLD alert type (quota-alerting goal)
-- Usage-quota watermark alerts reuse the alert_rules machinery; the CHECK
-- constraint must admit the new type.
