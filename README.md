...
MiQroEra 面向企业内部 AI 编程场景的凭证虚拟化与用量治理系统，产品简称 **MiQroKey**。
...
当前阶段为“开发前设计基线”，下一步从 Goal `G0.1 Repository bootstrap` 开始。文档中的供应商能力分为“官方资料确认”“已实现”“真实凭证已验证”等层级；只有通过真实凭证契约测试的适配器才能在正式目录中标记为“已验证”。
